...
defined('CLAIM_XML_CANCELLATION')     OR define('CLAIM_XML_CANCELLATION', 'cancellation'); // doc upload path
...
defined('CLAIM_SENDER_ID')      	OR define('CLAIM_SENDER_ID', 'CL-PP-0045-08'); // doc upload path
...
defined('MODULE_BILL')        			OR define('MODULE_BILL', 62);
...
//erxPrescription
defined('SENDER_ID')      	OR define('SENDER_ID', 'DHA-F-0047293'); // doc upload path
defined('RECEIVER_ID')      	OR define('RECEIVER_ID', 'DHA-F-0047293'); // doc upload path
...
defined('ERX_REQUEST_CANCELLATION')   OR define('ERX_REQUEST_CANCELLATION', 'eRxCancellation'); // doc 
...
defined('RADIOLOGY_UPLOAD_PATH')      OR define('RADIOLOGY_UPLOAD_PATH', 'public/uploads/radiologyupload/');