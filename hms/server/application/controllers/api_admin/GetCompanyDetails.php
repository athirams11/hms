...
{	
    ...
    public function index_post()
    {
      ...
      $result     = $this->ApiAdminModel->GetCompanyDetails($post_data);
      log_activity('Admin-GetCompanyDetails',"Message : ".json_encode($result),"Posted Data :".json_encode($post_data)); 
