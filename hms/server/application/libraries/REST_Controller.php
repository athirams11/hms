...
abstract class REST_Controller extends \CI_Controller {
     ...
     * Determines whether the XSS filter is always active when
     * GET, OPTIONS, HEAD, POST, PUT, DELETE and PATCH data is encountered
     * Set automatically based on authentication
     *
     * @var bool
     */
     ...
     */
    public function __construct($config = 'rest_server')
    {
        parent::__construct();
        ...
        // At present the library is bundled with RestController 2.5+, but will eventually be part of CodeIgniter (no citation)
        ...
        {
             $this->_authorized = $this->_allow = $this->_detect_api_key();
        }
    ...
    {       
        ...
        elseif ($this->config->item('rest_enable_logging') && $log_method)
        {
         ...
         if(!$this->_authorized)return false;
