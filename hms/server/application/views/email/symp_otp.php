      ...
      <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #FFFFFF;" class="block-grid ">
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:#E3E8E5;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:#FFFFFF;"><![endif]-->
              ...
              <!--[if (mso)|(IE)]><td align="center" width="600" style=" width:600px; padding-right: 0px; padding-left: 0px; padding-top:0px; padding-bottom:0px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><![endif]-->
            <div class="col num12" style="min-width: 320px;max-width: 600px;display: table-cell;vertical-align: top;padding-bottom:5px;">
              <div style="background-color: transparent; width: 100% !important;">
              <!--[if (!mso)&(!IE)]><!-->
              <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                    ...
                    <div align="center" class="img-container center  autowidth  fullwidth" style="padding-right: 10px;  padding-left: 45px;padding-top:70px; float:left;width:200px;">
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                      <a href="<?=SITE_URL_MOBISAC?>" target="_blank">
                        <img class="center  autowidth  fullwidth" align="center" border="0" src="<?=base_url()?>public/assets/images/LOGO_APP_HOME.png" alt="Mobisac" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px" >
                      </a>
                      <p style="margin: 0;font-size: 15px;line-height: 40px;text-align: left;font-weight: bold; color:#0070FF;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;">ACTIVATION CODE</p>
                    <!--[if mso]></td></tr></table><![endif]-->
                    </div>
                    <div align="center" class="img-container center  autowidth  fullwidth" style="padding-left: 10px; float:right;width:327px;">
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                        <img class="center" align="center" border="0" src="<?=base_url()?>public/assets/icons/email_top.png" alt="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px">
                    <!--[if mso]></td></tr></table><![endif]-->
                    </div>
          ...
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:#E3E8E5;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:#FFFFFF;"><![endif]-->
            ...
            <div class="col num12" style="min-width: 320px;max-width: 600px;display: table-cell;vertical-align: top;">
              ...
              <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                ...
                <div style="font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;line-height:150%;color:#555555; padding-right: 40px; padding-left: 40px; padding-top: 10px; padding-bottom: 10px;"> 
                    ...
                    <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;text-align:left;">
                        <p style="margin: 0;font-size: 12px;line-height: 25px;text-align: left;padding:0px;">      
                          <? //echo 'lang('dear_customer')';?>
                          <? echo 'Hi, ';?> <?php echo $customer_name; ?><br>
                          <? echo 'Symp registration verification code is: ';?><br><br>
                          <span style="line-height: 36px; font-size: 50px;font-weight:bold;color:#0070FF;"><?php echo $otp;?><br>
                        </p>
                    </div>  
                </div>
                <!--[if mso]></td></tr></table><![endif]-->
      ...
      <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid ">
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:transparent;"><![endif]-->
            ...
            <div class="col num12" style="min-width: 320px;max-width: 600px;display: table-cell;vertical-align: top;padding-bottom:0px;">
              
              <!--[if (!mso)&(!IE)]><!-->
              <div style="padding-top:5px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                    ...
                    <div style="font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;line-height:150%;color:#FFFFFF; padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 0px;float:left;width:250px;">  
                        <img class="center" align="center" border="0" src="<?=base_url()?>public/assets/icons/email_bottom.png" alt="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px" >
                    </div>
                    <!--[if mso]></td></tr></table><![endif]-->

                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
                    <div style="font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;line-height:150%;color:#FFFFFF; padding-right: 0px; padding-left: 0px; padding-top: 40px; padding-bottom: 0px;">  
                        <div style="font-size:15px;line-height:18px;color:#FFFFFF;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;text-align:left;">
                            <p style="margin: 0;font-size: 15px;line-height: 18px;text-align: left;font-weight: bold; color:#4c4c4c;">Thank you for using our services.</p>
                            <p style="margin: 0;font-size: 15px;line-height: 40px;text-align: left;font-weight: bold; color:#00bbfa;">Symp Team</p>
                            <p style="margin-bottom: -14px;font-size: 12px;text-align: left;font-weight: bold;"> 
                            <a style="text-decoration: none;color:#007af7;" href="<?=SYMP_SITE_URL?>" target="_blank" rel="noopener noreferrer">Symp &copy; 2018</a>
                            <span style="font-size: 12px;font-weight:bold; color:#007af7"> - <? echo lang('all_rights_reserved');?></span> <br data-mce-bogus="1"></p></div>   
                    </div>
                    <!--[if mso]></td></tr></table><![endif]-->
