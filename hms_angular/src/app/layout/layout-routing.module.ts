...
const routes: Routes = [
    {
        ...
        children: [
            ...
            //{ path: 'consent', loadChildren: './dashboards/dashboards.module#DashboardsModule' },
            ...
            { path: 'dashboards', loadChildren: './dashboards/dashboards.module#DashboardsModule', canActivate: [AuthGuard], data: {level : 1, path: '/dashboards'} },
