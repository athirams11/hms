...
import { LoaderService, DoctorsService, OpVisitService, NursingAssesmentService } from 'src/app/shared';
...
export class DuplicateInvoiceComponent implements OnInit {
  ...
  cash_payment_mode = 0;
  constructor(private loaderService : LoaderService,public Doc:DoctorsService,private modalService: NgbModal,public bill:BillingService,public nas: NursingAssesmentService,notifierService: NotifierService, public datepipe: DatePipe,private router: Router) 
  {
       ...
       this.bill_details = result.data
        ...
        for(let bill of result.data)
        {
          ...
          if(bill.BILL_TYPE == 1)
          {
            ...
            this.claim_patienttotal = parseFloat(bill.PAID_BY_PATIENT) - parseFloat(bill.PATIENT_DISCOUNT);
          ...
          if(bill.BILL_TYPE == 0)
          {
            ...
            // console.log(this.invoice_data.cash_discount_type)
            this.cash_patienttotal = parseFloat(bill.PAID_BY_PATIENT) - parseFloat(bill.PATIENT_DISCOUNT);
            ...
            this.cash_patient_payable_total = parseFloat(bill.PAID_BY_PATIENT) 
