...
@Component({
  selector: 'app-chiefcomplaints',
  templateUrl: './chiefcomplaints.component.html',
  styleUrls: ['./chiefcomplaints.component.scss']
})
export class ChiefcomplaintsComponent implements OnInit,OnChanges {
  ...
  public procedure_result : string;
 ...
 //  console.log(this.dental_data)
  ...
  public labels: { id: number, label: string, value: string,key_name:string }[] = [
    ...
    { "id": 6, "label": "Lab/Procedure Results" , value: "0",key_name:"procedure_result"},
  ...
  public getEvent()
  {
    ...
    if(formatDate(this.todaysDate) == formatDate(this.selected_visit.CREATED_TIME))
    {
      ...
      if(this.get_status == 1)
      {
          ...
          this.complaint_data["procedure_result"] == this.get_complaint_data["procedure_result"]&&
  ...
  public Complaints(val)
  {
    if(val == 1)
    {
      if(Object.keys(this.complaint_data).length > 2)
      {
        ...
        if(this.complaint_data["procedure_result"] != "" || this.complaint_data["procedure_result"] != null )
        {
          this.copy_complaint_data.procedure_result = this.complaint_data["procedure_result"]
        }
    ...
    else
    {
      ...
      this.complaint_data = {
        ...
        procedure_result: this.copy_complaint_data["procedure_result"],
      }
