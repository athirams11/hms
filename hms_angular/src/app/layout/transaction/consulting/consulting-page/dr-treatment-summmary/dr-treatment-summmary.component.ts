...
@Component({
  selector: 'app-dr-treatment-summmary',
  templateUrl: './dr-treatment-summmary.component.html',
  styleUrls: ['./dr-treatment-summmary.component.scss']
})
export class DrTreatmentSummmaryComponent implements OnInit,OnChanges {
